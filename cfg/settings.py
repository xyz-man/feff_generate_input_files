...
TYPE_OF_PROCEDURE_CHANGING_INPUT_STRUCTURE = 'central_atom_is_stable_and_move_target_atom'
...
if DEBUG:
    ...
    POLARIZATION = '100'
    SRC_FEFF_INPUT_FILE_NAME = 'feff_ZnO-i-Yb-octa_c=Yb_m=O_{pol}.inp'.format(pol=POLARIZATION)
    TARGET_ATOM_TAG = 'O'
    TARGET_ATOM_IPOT = 2
    ...
    PROJECT_NAME = 'ZnO_i=[{ctag}]_m={ttag}_c={ctag}_p=[pol]'.format(
        ctag=CENTRAL_ATOM_TAG,
        ttag=TARGET_ATOM_TAG,
        pol=POLARIZATION)
    TYPE_OF_CALCULATION = 'local'
    PROJECT_OUT_DIRECTORY_PATH = '/home/yugin/PycharmProjects/feff_generate_input_files/tmp'
    TARGET_ATOM_MAX_DISTANCE = 3.25
